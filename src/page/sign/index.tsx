...
export default function EIP712(p: { value: string }) {
    ...
    const btnClickSign = useCallback(() => {
    ...
    }, [web3.library, web3.account, nonce, web3.chainId, inputV])
                        ...
                        return (
                            <ListItem key={i}>
                                {item.txResult === 0 ? (
                                    ...
                                    <ListItemIcon className={classes2.root}>
                                ...
                                <CopyToClipboard onCopy={onCopy} text={item.hash}>
    ...
    }, [web3.account, hashArr])


    return (
        <div role="tabpanel" className={classes.panel} hidden={p.value !== 'eip712'}>
            <Card className={classes.root}>
                <Card className={classes.childDisplay}>
                    <Card>amount :{amount}</Card>
                    <Card>nonce :{nonce}</Card>
                </Card>
                {renderList}
            </Card>
            <div className={classes.btn}>
                <XTextNumberField
                    ...
                    type="number"
                />
                <Button disabled={sendBtnIsEnable} onClick={btnClickSign}>
                    approve add amount
                </Button>
            </div>
        </div>
